...
ifort /MD /c /Qopenmp /O3  /nostandard-realloc-lhs ./src/RRI/RSR_Mod.f90
...
ifort /MD /c /Qopenmp /O3  /nostandard-realloc-lhs ./src/RRI/RRI_Sediment.f90 
ifort /MD /c /Qopenmp /O3  /nostandard-realloc-lhs ./src/RRI/RRI_Sed2.f90 
...
ifort /MD /Qopenmp /O3 *.obj ./lib/iriclib.lib /o  ./rri.exe
